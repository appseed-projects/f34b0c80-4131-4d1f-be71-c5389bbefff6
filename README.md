...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-14 16:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f34b0c80-4131-4d1f-be71-c5389bbefff6.git
$ cd f34b0c80-4131-4d1f-be71-c5389bbefff6
```
